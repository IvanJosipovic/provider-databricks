...
import (
	...
	apisCluster "github.com/ivanjosipovic/provider-databricks/apis/cluster"
	apisNamespaced "github.com/ivanjosipovic/provider-databricks/apis/namespaced"
	"github.com/ivanjosipovic/provider-databricks/config"
	"github.com/ivanjosipovic/provider-databricks/internal/clients"
	controllerCluster "github.com/ivanjosipovic/provider-databricks/internal/controller/cluster"
	controllerNamespaced "github.com/ivanjosipovic/provider-databricks/internal/controller/namespaced"
	"github.com/ivanjosipovic/provider-databricks/internal/features"
	"github.com/ivanjosipovic/provider-databricks/internal/version"
)
...
func main() {
	...
	kingpin.FatalIfError(apisCluster.AddToScheme(mgr.GetScheme()), "Cannot add cluster-scoped Databricks APIs to scheme")
	kingpin.FatalIfError(apisNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add namespaced Databricks APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated(mgr, clusterOpts), "Cannot setup cluster-scoped Databricks controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated(mgr, namespacedOpts), "Cannot setup namespaced Databricks controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup(mgr, clusterOpts), "Cannot setup cluster-scoped Databricks controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup(mgr, namespacedOpts), "Cannot setup namespaced Databricks controllers")
	}
